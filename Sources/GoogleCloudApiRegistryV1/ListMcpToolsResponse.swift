...
public struct ListMcpToolsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of McpTool
  ...
  /// Initialize a new instance of `ListMcpToolsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMcpToolsResponse().with { $0.mcpTools = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let mcpTools = CodingKeys(stringValue: "mcpTools")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([McpTool].self, forKey: .mcpTools) {
      self.mcpTools = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.mcpTools, forKey: .mcpTools)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apiregistry.v1.ListMcpToolsResponse"
  }
...
extension ListMcpToolsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [McpTool] {
    return self.mcpTools
  }
