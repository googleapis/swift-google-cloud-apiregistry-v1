...
public struct ListMcpServersResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListMcpServersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMcpServersResponse().with { $0.mcpServers = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let mcpServers = CodingKeys(stringValue: "mcpServers")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([McpServer].self, forKey: .mcpServers) {
      self.mcpServers = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.mcpServers, forKey: .mcpServers)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apiregistry.v1.ListMcpServersResponse"
  }
