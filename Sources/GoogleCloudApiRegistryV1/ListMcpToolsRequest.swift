...
public struct ListMcpToolsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMcpToolsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMcpToolsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apiregistry.v1.ListMcpToolsRequest"
  }
